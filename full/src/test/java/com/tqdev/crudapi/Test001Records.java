...
public class Test001Records {
	...
	public void test001ListPosts() throws Exception {
		mockMvc.perform(get("/records/posts")).andExpect(status().isOk()).andExpect(content().string(
	...
	public void test002ListPostColumns() throws Exception {
		mockMvc.perform(get("/records/posts?columns=id,content")).andExpect(status().isOk()).andExpect(content().string(
				"{\"records\":[{\"id\":1,\"content\":\"blog started\"},{\"id\":2,\"content\":\"It works!\"}]}"));
	}

	@Test
	public void test003ReadPost() throws Exception {
		mockMvc.perform(get("/records/posts/2")).andExpect(status().isOk())
				.andExpect(content().string("{\"id\":2,\"user_id\":1,\"category_id\":2,\"content\":\"It works!\"}"));
	}

	@Test
	public void test004ReadPosts() throws Exception {
		mockMvc.perform(get("/records/posts/1,2")).andExpect(status().isOk()).andExpect(content().string(
	...
	public void test005ReadPostColumns() throws Exception {
		mockMvc.perform(get("/records/posts/2?columns=id,content")).andExpect(status().isOk())
				.andExpect(content().string("{\"id\":2,\"content\":\"It works!\"}"));
	}

	@Test
	public void test006AddPost() throws Exception {
		mockMvc.perform(post("/records/posts").contentType("application/json")
	...
	public void test007EditPost() throws Exception {
		mockMvc.perform(put("/records/posts/3").contentType("application/json")
				.content("{\"user_id\":1,\"category_id\":1,\"content\":\"test (edited)\"}")).andExpect(status().isOk())
				.andExpect(content().string("1"));
		mockMvc.perform(get("/records/posts/3")).andExpect(status().isOk()).andExpect(
	...
	public void test008EditPostColumnsMissingField() throws Exception {
		mockMvc.perform(put("/records/posts/3?columns=id,content").contentType("application/json")
	...
	public void test010EditPostWithUtf8Content() throws Exception {
		...
		mockMvc.perform(put("/records/posts/2").contentType("application/json").content("{\"content\":\"" + utf8 + "\"}"))
	...
	public void test011EditPostWithUtf8ContentWithPost() throws Exception {
		...
		mockMvc.perform(
				put("/records/posts/2").contentType("application/x-www-form-urlencoded").content("content=" + urlenc))
				.andExpect(status().isOk()).andExpect(content().string("1"));
		mockMvc.perform(get("/records/posts/2")).andExpect(status().isOk())
				.andExpect(content().json("{\"id\":2,\"user_id\":1,\"category_id\":2,\"content\":\"" + utf8 + "\"}"));
	}
	...
	public void test012DeletePost() throws Exception {
		mockMvc.perform(delete("/records/posts/3")).andExpect(status().isOk()).andExpect(content().string("1"));
		mockMvc.perform(get("/records/posts/3")).andExpect(status().isNotFound())
				.andExpect(content().string("{\"code\":1003,\"message\":\"Record '3' not found\"}"));
	}

	@Test
	public void test013AddPostWithPost() throws Exception {
		mockMvc.perform(post("/records/posts").contentType("application/x-www-form-urlencoded")
				.content("user_id=1&category_id=1&content=test")).andExpect(status().isOk())
	...
	public void test014EditPostWithPost() throws Exception {
		mockMvc.perform(put("/records/posts/4").contentType("application/x-www-form-urlencoded")
				.content("user_id=1&category_id=1&content=test+(edited)")).andExpect(status().isOk())
				.andExpect(content().string("1"));
		mockMvc.perform(get("/records/posts/4")).andExpect(status().isOk()).andExpect(
	...
	public void test015DeletePostIgnoreColumns() throws Exception {
		mockMvc.perform(delete("/records/posts/4?columns=id,content")).andExpect(status().isOk())
				.andExpect(content().string("1"));
		mockMvc.perform(get("/records/posts/4")).andExpect(status().isNotFound())
	...
	public void test016ListWithPaginate() throws Exception {
		...
		mockMvc.perform(get("/records/posts?page=2,2&order=id")).andExpect(status().isOk()).andExpect(content().string(
	...
	public void test019ListWithPaginateInMultipleOrder() throws Exception {
		mockMvc.perform(get("/records/posts?page=1,2&order=category_id,asc&order=id,desc").accept("application/json"))
	...
	public void test020ListWithPaginateInDescendingOrder() throws Exception {
		mockMvc.perform(get("/records/posts?page=2,2&order=id,desc").accept("application/json")).andExpect(status().isOk())
	...
	public void test021ListWithSize() throws Exception {
		mockMvc.perform(get("/records/posts?order=id&size=1")).andExpect(status().isOk()).andExpect(content()
				.string("{\"records\":[{\"id\":1,\"user_id\":1,\"category_id\":1,\"content\":\"blog started\"}]}"));
	}

	@Test
	public void test022ListWithZeroPageSize() throws Exception {
		mockMvc.perform(get("/records/posts?order=id&page=1,0")).andExpect(status().isOk())
				.andExpect(content().string("{\"records\":[],\"results\":12}"));
	}

	@Test
	public void test023ListWithZeroSize() throws Exception {
		mockMvc.perform(get("/records/posts?order=id&size=0")).andExpect(status().isOk())
				.andExpect(content().string("{\"records\":[]}"));
	}

	@Test
	public void test024ListWithPaginateLastPage() throws Exception {
		mockMvc.perform(get("/records/posts?page=3,5&order=id")).andExpect(status().isOk()).andExpect(content().string(
	...
	public void test025ListExampleFromReadmeFullRecord() throws Exception {
		mockMvc.perform(get("/records/posts?filter=id,eq,1")).andExpect(status().isOk()).andExpect(content()
				.string("{\"records\":[{\"id\":1,\"user_id\":1,\"category_id\":1,\"content\":\"blog started\"}]}"));
	}

	@Test
	public void test026ListExampleFromReadmeWithExclude() throws Exception {
		mockMvc.perform(get("/records/posts?exclude=id&filter=id,eq,1")).andExpect(status().isOk()).andExpect(
	...
	public void test027ListExampleFromReadmeUsersOnly() throws Exception {
		mockMvc.perform(get("/records/posts?include=users&filter=id,eq,1")).andExpect(status().isOk()).andExpect(content()
	...
	public void test028ReadExampleFromReadmeUsersOnly() throws Exception {
		mockMvc.perform(get("/records/posts/1?include=users")).andExpect(status().isOk()).andExpect(content().string(
	...
	public void test029ListExampleFromReadmeCommentsOnly() throws Exception {
		mockMvc.perform(get("/records/posts?include=comments&filter=id,eq,1")).andExpect(status().isOk())
				.andExpect(content().string(
	...
	public void test030ListExampleFromReadmeTagsOnly() throws Exception {
		mockMvc.perform(get("/records/posts?include=tags&filter=id,eq,1")).andExpect(status().isOk()).andExpect(content()
	...
	public void test031ListExampleFromReadmeTagsWithIncludePath() throws Exception {
		mockMvc.perform(get("/records/posts?include=categories&include=post_tags,tags&include=comments&filter=id,eq,1"))
				.andExpect(status().isOk()).andExpect(content().string(
	...
	public void test032ListExampleFromReadme() throws Exception {
		mockMvc.perform(get("/records/posts?include=categories&include=tags&include=comments&filter=id,eq,1"))
				.andExpect(status().isOk()).andExpect(content().string(
	...
	public void test036EditCategoryWithNull() throws Exception {
		...
		mockMvc.perform(put("/records/categories/2").contentType("application/json").content("{\"icon\":null}"))
				.andExpect(status().isOk()).andExpect(content().string("1"));
		mockMvc.perform(get("/records/categories/2")).andExpect(status().isOk())
	...
	public void test038ListCategoriesWithBinaryContent() throws Exception {
		mockMvc.perform(get("/records/categories")).andExpect(status().isOk()).andExpect(content().string(
	...
	public void test039EditCategoryWithNullWithPost() throws Exception {
		mockMvc.perform(
				put("/records/categories/2").contentType("application/x-www-form-urlencoded").content("icon__is_null"))
				.andExpect(status().isOk()).andExpect(content().string("1"));
		mockMvc.perform(get("/records/categories/2")).andExpect(status().isOk())
				.andExpect(content().string("{\"id\":2,\"name\":\"article\",\"icon\":null}"));
	}
	...
	public void test040AddPostFailure() throws Exception {
		mockMvc.perform(post("/records/posts").contentType("application/json").content("[\"truncat")).andExpect(status().isNotAcceptable())
				.andExpect(content().string("{\"code\":1008,\"message\":\"Cannot read HTTP message\"}"));
	}

	@Test
	public void test041CorsPreFlight() throws Exception {
		mockMvc.perform(options("/records/posts/1?columns=id").header("Origin", "http://example.com")
	...
	public void test042CorsHeaders() throws Exception {
		mockMvc.perform(get("/records/posts/1?columns=id").header("Origin", "http://example.com")).andExpect(status().isOk())
				.andExpect(header().string("Access-Control-Allow-Origin", "http://example.com"))
				.andExpect(header().string("Access-Control-Allow-Credentials", "true"));
	}
	...
	public void test043ErrorOnInvalidJson() throws Exception {
		mockMvc.perform(post("/records/posts").contentType("application/json").content("{\"}"))
	...
	public void test046ErrorOnNonExistingTable() throws Exception {
		mockMvc.perform(get("/records/postzzz")).andExpect(status().isNotFound())
	...
	public void test048ErrorOnInvalidArgumentCount() throws Exception {
		mockMvc.perform(put("/records/posts/1,2").contentType("application/json")
	...
	public void test050NoErrorOnArgumentCountOne() throws Exception {
		mockMvc.perform(put("/records/posts/1").contentType("application/json")
				.content("[{\"id\":1,\"user_id\":1,\"category_id\":1,\"content\":\"blog started\"}]"))
				.andExpect(status().isOk()).andExpect(content().string("[1]"));
	}
	...
	public void test051ErrorOnInvalidArgumentCount() throws Exception {
		mockMvc.perform(put("/records/posts/1").contentType("application/json").content("[{\"id\":1},{\"id\":2}]"))
				.andExpect(status().isNotAcceptable())
	...
	public void test052EditUserLocation() throws Exception {
		mockMvc.perform(put("/records/users/1").contentType("application/json").content("{\"location\":\"POINT(30 20)\"}"))
				.andExpect(status().isOk()).andExpect(content().string("1"));
		mockMvc.perform(get("/records/users/1?columns=id,location")).andExpect(status().isOk())
				.andExpect(content().string("{\"id\":1,\"location\":\"POINT(30 20)\"}"));
	}

	@Test
	public void test053ListUserLocations() throws Exception {
		mockMvc.perform(get("/records/users?columns=id,location")).andExpect(status().isOk()).andExpect(content()
	...
	public void test054EditUserWithId() throws Exception {
		mockMvc.perform(
				put("/records/users/1").contentType("application/json").content("{\"id\":2,\"password\":\"testtest2\"}"))
				.andExpect(status().isOk()).andExpect(content().string("1"));
		mockMvc.perform(get("/records/users/1?columns=id,username,password")).andExpect(status().isOk())
	...
	public void test055FilterCategoryOnNullIcon() throws Exception {
		mockMvc.perform(get("/records/categories?filter=icon,is,null")).andExpect(status().isOk()).andExpect(content()
	...
	public void test056FilterCategoryOnNotNullIcon() throws Exception {
		mockMvc.perform(get("/records/categories?filter=icon,nis,null")).andExpect(status().isOk())
				.andExpect(content().string("{\"records\":[]}"));
	}

	@Test
	public void test057FilterOnAnd() throws Exception {
		mockMvc.perform(get("/records/posts?columns=id&filter=id,ge,1&filter=id,le,2")).andExpect(status().isOk())
				.andExpect(content().string("{\"records\":[{\"id\":1},{\"id\":2}]}"));
	}

	@Test
	public void test058FilterOnOr() throws Exception {
		mockMvc.perform(get("/records/posts?columns=id&filter1=id,eq,1&filter2=id,eq,2")).andExpect(status().isOk())
				.andExpect(content().string("{\"records\":[{\"id\":1},{\"id\":2}]}"));
	}

	@Test
	public void test059FilterOnAndPlusOr() throws Exception {
		mockMvc.perform(get("/records/posts?columns=id&filter1=id,eq,1&filter2=id,gt,1&filter2=id,lt,3"))
				.andExpect(status().isOk()).andExpect(content().string("{\"records\":[{\"id\":1},{\"id\":2}]}"));
	}

	@Test
	public void test060FilterOnOrPlusAnd() throws Exception {
		mockMvc.perform(get("/records/posts?columns=id&filter1=id,eq,1&filter2=id,eq,2&filter=user_id,eq,1"))
				.andExpect(status().isOk()).andExpect(content().string("{\"records\":[{\"id\":1},{\"id\":2}]}"));
	}

	@Test
	public void test061GetPostContentWithIncludedTagNames() throws Exception {
		mockMvc.perform(get("/records/posts/1?columns=content,tags.name&include=tags")).andExpect(status().isOk())
				.andExpect(content().string(
	...
	public void test062MetaGetDatabase() throws Exception {
		mockMvc.perform(getTable("/meta")).andExpect(status().isOk())
				.andExpect(content().string(
	...
	public void test062MetaGetBarcodesTable() throws Exception {
		mockMvc.perform(getTable("/meta/barcodes")).andExpect(status().isOk())
				.andExpect(content().string(
						"{\"records\":[{\"id\":1,\"Umlauts ä_ö_ü-COUNT\":1}]}"));
	}
	...
	public void test062MetaGetBarcodesIdColumn() throws Exception {
		mockMvc.perform(getTable("/meta/barcodes/id")).andExpect(status().isOk())
				.andExpect(content().string(
						"{\"records\":[{\"id\":1,\"Umlauts ä_ö_ü-COUNT\":1}]}"));
	}*/
}